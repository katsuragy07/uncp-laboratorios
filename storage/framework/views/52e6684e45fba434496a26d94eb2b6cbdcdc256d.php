...
<?php $__env->startSection('titulo','Equipos de seguridad'); ?>
   ...
   <!-- Modal Nuevo y editar -->
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                	<form action="<?php echo e(route('listar.equipo_seguridad_lab')); ?>" method="GET">
                    <div class="row">
                        <div class="col-lg">
            ...
            <div class="card">
                <div class="card-body">
                	<form class="form-horizontal" action="<?php echo e(route('mant.equipo_seguridad_lab')); ?>" method="POST" enctype="multipart/form-data">
                		<?php echo csrf_field(); ?>
						...
						<table class="table table-hover card-table table-vcenter text-nowrap mb-0">
							<thead>
								<tr>
									...
									<th width="10%">Estado/Condición</th>
							...
							<tbody>
								...
								$i++;  ?>
									<tr>
										<td><?php echo e($i); ?></td>
										<td><?php echo e($fila->equipo_seguridad); ?></td>
										<td><?php echo e($fila->tipo); ?></td>
										 
										<td >
											<?php if($databusqueda->laboratorio_id>0): ?>
											<input  id="est_privilegio<?php echo $fila->id; ?>" <?php if($fila->equipo_seguridad_lab_id>0) {    echo "checked"; }?> name="equipo_id[]" type="checkbox" onxclick="permiso(<?php echo $fila->id; ?>);" value="<?php echo $fila->id; ?>"/>
											<?php else: ?>
											-
											<?php endif; ?>
										...
										<?php if($databusqueda->laboratorio_id>0): ?>
											<td><input type="number" name="cantidad<?php echo $fila->id; ?>" class="zform-control" value="<?php echo e($fila->cantidad); ?>"></td>
											<td><input type="text" name="estado<?php echo $fila->id; ?>" class="zform-control" value="<?php echo e($fila->estado); ?>"></td>
											<td><input type="text" name="motivo_elim<?php echo $fila->id; ?>" class="zform-control" value="<?php echo e($fila->motivo_elim); ?>"></td>
										<?php endif; ?>
				    ...
				    <div class="text-center">
				    	<?php if($databusqueda->laboratorio_id>0): ?>
				    		<input type="hidden" name="laboratorio_id" value="<?php echo $databusqueda->laboratorio_id;?>">
...
function permiso(id){  
    ...
    $.ajax({ 
        type: "post",
        url: "<?php echo e(route('mant.equipo_seguridad_lab')); ?>", cache: false, 
        data:{
...
<?php echo $__env->make('layouts.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/equipos/mant_equipo_seguridad_lab.blade.php ENDPATH**/ ?>