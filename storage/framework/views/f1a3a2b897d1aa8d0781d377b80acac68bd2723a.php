...
<?php $m_tipopersonal = app('App\Models\Tipopersonal'); ?>
...
<div class="modal fade" id="modal_mante" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?php echo e(route('guardar.personal')); ?>" method="POST" enctype="multipart/form-data" id="frmproy">
					<?php echo csrf_field(); ?> 
				<div class="modal-body">
					<div class="form-group row">
						...
						<div class="col-md-6">
							...
							<select name="laboratorio_id" id="laboratorio_id" required="" class="form-control">
								...
								<option <?php if($laboratorio->id == @$info->laboratorio_id): ?> selected <?php endif; ?> value="<?php echo e($laboratorio->id); ?>"><?php echo e($laboratorio->full_name); ?></option>
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<select  id='persona_id' name="persona_id"  style="width: 100%;" class="select2AjaxPersona">
								<?php if(@$info->persona_id>0): ?>
									<option selected value="<?php echo e($info->persona_id); ?>"><?php echo e($funciones->info_persona($info->persona_id)); ?></option>
								<?php endif; ?>
							</select>	
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<select name="tipopersonal_id" id="tipopersonal_id"  required="" class="form-control" > 
								<option value="">-- Seleccionar --</option>
								<?php $__currentLoopData = $m_tipopersonal::orderby('tipo_personal','ASC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipopersonal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option <?php if($tipopersonal->id == @$info->tipopersonal_id): ?> selected <?php endif; ?> value="<?php echo e($tipopersonal->id); ?>"><?php echo e($tipopersonal->tipo_personal); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<select name="cargo_id" id="cargo_id"  required="" class="form-control" > 
								...
								<option <?php if($cargo->id == @$info->cargo_id): ?> selected <?php endif; ?> value="<?php echo e($cargo->id); ?>"><?php echo e($cargo->cargo); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" name="especialidad" required="" class="form-control"  value="<?php echo e(@$info->especialidad); ?>">
						</div>
					</div>		
					<div class="form-group row">
						<label class="col-md-3 form-label">Fecha Ingreso al Cargo</label>
						<div class="col-md-9">
							<input type="date" name="fch_ingreso" class="form-control"  value="<?php echo e(@$info->fch_ingreso); ?>">
						</div>
					</div>	
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="date" name="fch_cese" class="form-control"  value="<?php echo e(@$info->fch_cese); ?>">
						</div>
					</div>	
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="file" name="hoja_vida" id="hoja_vida" accept=".pdf" class="form-control"  value="<?php echo e(@$info->hoja_vida); ?> " style="display:none;">
							...
							<?php 
								if(@$info->hoja_vida!=''){
								?><a href="files/personal/<?php echo e(@$info->hoja_vida); ?>" class="f_hoja_vida text-info" target="_blank" title="Descargarddd"><?php  echo @$info->hoja_vida; ?></a>
								<input type="hidden" name="f_hoja_vida" id="f_hoja_vida" value="<?php echo e(@$info->hoja_vida); ?>">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="file" name="resolucion" id="resolucion"  accept=".pdf" class="form-control"  value="<?php echo e(@$info->resolucion); ?>" style="display:none;">
							...
							<div class="flex m-2" style="color: #29327f;font-size: 1.1rem;max-width: 100%;" id="val_resolucion" value="<?php echo e(@$info->resolucion); ?>"></div>

							<?php 
								if(@$info->resolucion!=''){
								?><a href="files/personal/<?php echo e(@$info->resolucion); ?>" class="f_resolucion text-info" target="_blank" title="Descargar"><?php  echo @$info->resolucion; ?></a>
								<input type="hidden" name="f_resolucion" id="f_resolucion" value="<?php echo e(@$info->resolucion); ?>">
	...
	</script><?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/personal/modal_form_personal.blade.php ENDPATH**/ ?>