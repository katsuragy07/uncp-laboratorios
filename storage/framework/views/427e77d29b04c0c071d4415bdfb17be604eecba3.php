...
<?php $__env->startSection('titulo','Catálogo de Documento de Almacen/Laboratorio'); ?>
   ...
   <!-- Modal Nuevo y editar -->
	<div class="modal fade" id="modal_nuevo" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?php echo e(route('guardar.tipo_doc_especifico')); ?>" method="POST">
					<?php echo csrf_field(); ?>					
		...
		<div class="modal-dialog modal-dialog-centered text-center" role="document">
			<div class="modal-content tx-size-sm">
				<div class="modal-body text-center p-4">
					...
					<form action="<?php echo e(route('borrar.tipo_doc_especifico')); ?>" method="POST">
						<?php echo csrf_field(); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                	<form action="<?php echo e(route('listar.tipo_doc_especifico')); ?>" method="GET">
                    <div class="row">
                        <div class="col-lg">
                            <label class="form-label">Documento de Almacen/Laboratorio</label>
                            <input class="form-control mb-4" placeholder="" type="text" name="tipo_doc_especifico" value="<?php echo e($databusqueda->tipo_doc_especifico); ?>">
                        </div>
                        <div class="col-lg "><br>
							...
							<tbody>
								...
								<?php $i++;  ?>
									<tr>
										...
										<td>
					        				<button type="button" class="btn-info" data-toggle="modal" data-target="#modal_nuevo" onclick="editar(<?php echo e($fila->id); ?>,'<?php echo e($fila->tipo_doc_especifico); ?>')" > 
					                            <i class="glyphicon glyphicon-edit"></i> 
					                        </button>

					                        <button class="btn-danger" data-toggle="modal" data-target="#modal_eliminar" onclick="eliminar(<?php echo e($fila->id); ?>,'<?php echo e($fila->tipo_doc_especifico); ?>')"> 
...
<?php echo $__env->make('layouts.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/mantenimiento/lista_tipo_doc_especifico.blade.php ENDPATH**/ ?>