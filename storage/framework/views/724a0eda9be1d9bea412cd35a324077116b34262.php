...
<?php $__env->startSection('titulo','Catálogo - Equipos de seguridad'); ?>
   ...
   <!-- Modal Nuevo y editar -->
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                	<form action="<?php echo e(route('listar.equipo_seguridad')); ?>" method="GET">
                    <div class="row">
                        <div class="col-lg">
                            <label class="form-label"> Equipo de seguridad</label>
                            <input class="form-control mb-4" placeholder="" type="text" name="equipo_seguridad" value="<?php echo e($databusqueda->equipo_seguridad); ?>">
                        </div>
                        <div class="col-lg "><br>
							...
							<tbody>
								...
								<?php $i++;  ?>
									<tr>
										...
										<td>
					        				<button type="button" class="btn-info" data-toggle="modal" data-target="#modal_nuevo" onclick="editar(<?php echo e($fila->id); ?>,'<?php echo e($fila->equipo_seguridad); ?>','<?php echo e($fila->tipo); ?>')" > 
					                            <i class="glyphicon glyphicon-edit"></i> 
					                        </button>

					                        <button class="btn-danger" data-toggle="modal" data-target="#modal_eliminar" onclick="eliminar(<?php echo e($fila->id); ?>,'<?php echo e($fila->equipo_seguridad); ?>')"> 
...
<script>
	function nuevo(){
		$('#txtid').val('');
		$('#txtequipo_seguridad').val('');		
	}

	function editar(id,equipo_seguridad,tipo) {
		$('#txtid').val(id);
		$('#cmbtipo').val(tipo);
		$('#txtequipo_seguridad').val(equipo_seguridad);
	}
...
<?php echo $__env->make('layouts.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/mantenimiento/lista_equipo_seguridad.blade.php ENDPATH**/ ?>