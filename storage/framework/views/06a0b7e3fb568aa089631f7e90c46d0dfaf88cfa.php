...
<div class="modal fade" id="modal_mante" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?php echo e(route('guardar.requerimiento')); ?>" method="POST">
					<?php echo csrf_field(); ?>
				<div class="modal-body"> 
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<select  id='encargado_lab_dest_id' name="encargado_lab_dest_id"  style="width: 100%;" class="select2AjaxPersona">
								<?php if(@$info->encargado_lab_dest_id>0): ?>
									<option selected value="<?php echo e($info->encargado_lab_dest_id); ?>"><?php echo e($funciones->info_persona($info->encargado_lab_dest_id)); ?></option>
								<?php endif; ?>
							</select>	
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<textarea name="nota_requerimiento" class="form-control"><?php echo e(@$info->nota_requerimiento); ?></textarea> 
...
recargarAjaxProdLab();
	...
	</script><?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/atencion/modal_form_requerimiento.blade.php ENDPATH**/ ?>