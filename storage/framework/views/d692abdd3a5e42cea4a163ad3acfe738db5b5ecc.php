...
<div class="modal fade" id="modal_mante"   role="dialog" aria-labelledby="largemodal" aria-hidden="true" >
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?php echo e(route('guardar.infoservicio')); ?>" method="POST" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<select  id='representante_id' name="representante_id" required=""  style="width: 100%;" class="select2AjaxPersona">
								<?php if(@$info->representante_id>0): ?>
									<option selected value="<?php echo e($info->representante_id); ?>"><?php echo e($funciones->info_persona($info->representante_id)); ?></option>
								<?php endif; ?>
							</select>	
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<select  id='personal_contacto_id' name="personal_contacto_id" required="" style="width: 100%;" class="select2AjaxPersona">
								<?php if(@$info->personal_contacto_id>0): ?>
									<option selected value="<?php echo e($info->personal_contacto_id); ?>"><?php echo e($funciones->info_persona($info->personal_contacto_id)); ?></option>
								<?php endif; ?>
							</select>	
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" name="producto" id="producto" class="form-control" required="" autocomplete="off" value="<?php echo e(@$info->producto); ?>">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
						<input type="text" name="servicio_solicitado" id="servicio_solicitado"  class="form-control" autocomplete="off" value="<?php echo e(@$info->servicio_solicitado); ?>">								
						</div>
					</div>
					...
					<div class="form-group row" >
						...
						<div class="col-md-4">
							<input type="text" name="marca" id="marca" class="form-control"  value="<?php echo e(@$info->marca); ?>">
						</div>

						<div class="col-md-2">
							<input type="text" name="ds_marca" placeholder="DS Marca" class="form-control"  value="<?php echo e(@$info->ds_marca); ?>">
						</div>

						<div class="col-md-2">
							<input type="text" name="ie_marca" placeholder="IE Marca" class="form-control"  value="<?php echo e(@$info->ie_marca); ?>">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" name="presentacion" class="form-control"  value="<?php echo e(@$info->presentacion); ?>">
						</div>
					</div>
					...
					<label class="col-md-3 form-label">Cantidad Muestra</label>
						<div class="col-md-3">
							<input type="number" name="cantidad_muestra" class="form-control"  value="<?php echo e(@$info->cantidad_muestra); ?>">
						</div>

						<label class="col-md-2 form-label">Cant. Lote declarado</label>
						<div class="col-md-4">
							<input type="number" name="cantidad_lote" class="form-control"  value="<?php echo e(@$info->cantidad_lote); ?>">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" name="identificacion" class="form-control"  value="<?php echo e(@$info->identificacion); ?>">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input type="date" name="fecha_produccion" class="form-control"  value="<?php echo e(@$info->fecha_produccion); ?>">
						</div>

						<label class="col-md-1 form-label">DS Fecha</label>
						<div class="col-md-4">
							<input type="date" name="ds_fecha_produccion" class="form-control"  value="<?php echo e(@$info->ds_fecha_produccion); ?>">
						</div>

						<label class="col-md-3 form-label">IE Fecha</label>
						<div class="col-md-4">
							<input type="date" name="ie_fecha_produccion" class="form-control"  value="<?php echo e(@$info->ie_fecha_produccion); ?>">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input type="date" name="fecha_vencimiento" id="fecha_vencimiento" class="form-control"  value="<?php echo e(@$info->fecha_vencimiento); ?>">
						</div>

						<label class="col-md-1 form-label">DS Fecha</label>
						<div class="col-md-4">
							<input type="date" name="ds_fecha_vencimiento" class="form-control"  value="<?php echo e(@$info->ds_fecha_vencimiento); ?>">
						</div>

						<label class="col-md-3 form-label">IE Fecha</label>
						<div class="col-md-4">
							<input type="date" name="ie_fecha_vencimiento" class="form-control"  value="<?php echo e(@$info->ie_fecha_vencimiento); ?>">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							...
							<textarea class="form-control" name="observacion" id="observacion" rows="3"> <?php echo e(@$info->observacion); ?></textarea>
				...
				<div class="container" id="contenidos_otros_servicios" >
					<div class="form-group row" id="m_punto_muestreo">
						...
						<div class="col-md-9">
							<input type="text" name="punto_muestreo" id="punto_muestreo" class="form-control"  value="<?php echo e(@$info->punto_muestreo); ?>">
						</div>
					</div>
					...
					<div class="form-group row" id="m_coordenadas">
						...
						<div class="col-md-9">
							<input type="text" name="coordenadas" id="coordenadas" class="form-control"  value="<?php echo e(@$info->coordenadas); ?>">
						</div>
					</div>
					...
					<div class="form-group row" id="m_ubigeo">
						...
						<div class="col-md-9">
							<select  id='ubigeo' name="ubigeo" id="ubigeo" style="width: 100%;" class="select2AjaxUbigeo">
								<?php if(@$info->ubigeo!=''): ?>
									<option selected value="<?php echo e($info->ubigeo); ?>"><?php echo e($funciones->info_ubigeo($info->ubigeo)); ?></option>
								<?php endif; ?>
					...
					<div class="form-group row" id="m_lugar">
						...
						<div class="col-md-9">
							<input type="text" name="lugar" id="lugar" class="form-control"  value="<?php echo e(@$info->lugar); ?>">
						</div>
					</div>
					...
					<div class="form-group row" id="m_fuente_origen">
						...
						<div class="col-md-9">
							<input type="text" name="fuente_origen" id="fuente_origen" class="form-control"  value="<?php echo e(@$info->fuente_origen); ?>">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<select  id='persona_muestreo_id' name="persona_muestreo_id"   style="width: 100%;" class="select2AjaxPersona">
								<?php if(@$info->persona_muestreo_id>0): ?>
									<option selected value="<?php echo e($info->persona_muestreo_id); ?>"><?php echo e($funciones->info_persona($info->persona_muestreo_id)); ?></option>
								<?php endif; ?>
							</select>	
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input type="date" name="fecha_muestreo" class="form-control"  value="<?php echo e(@$info->fecha_muestreo); ?>">
						</div>

						<label class="col-md-1 form-label">Hora muestreo</label>
						<div class="col-md-4">
							<input type="time" name="hora_muestreo" class="form-control"  value="<?php echo e(@$info->hora_muestreo); ?>">
						</div>
					...
					<div class="form-group row" id="m_tipo_envase">
						...
						<div class="col-md-9">
							<input type="text" name="tipo_envase" id="tipo_envase" class="form-control"  value="<?php echo e(@$info->tipo_envase); ?>">
						</div>
					</div>
					...
					<div class="form-group row" id="m_conservacion">
						...
						<div class="col-md-9">
							<input type="text" name="conservacion" id="conservacion" class="form-control"  value="<?php echo e(@$info->conservacion); ?>">
						</div>
					</div>
					...
					<div class="form-group row" id="m_preservacion">
						...
						<div class="col-md-9">
							<input type="text" name="preservacion" id="preservacion" class="form-control"  value="<?php echo e(@$info->preservacion); ?>">
						</div>
					</div>
					...
					<div class="form-group row" id="m_tipo_muestra">
						...
						<div class="col-md-9">
							<input type="text" name="tipo_muestra" id="tipo_muestra" class="form-control"  value="<?php echo e(@$info->tipo_muestra); ?>">
						</div>
					</div>
					...
					<div class="form-group row" id="m_descripcion_servicio">
						...
						<div class="col-md-9">
							<textarea class="form-control" name="descripcion_servicio" id="descripcion_servicio" rows="3"> <?php echo e(@$info->descripcion_servicio); ?></textarea>
					...
					<div class="form-group row" id="m_precio">
						...
						<div class="col-md-9">
							<input type="text" name="precio" id="precio" class="form-control" value="<?php echo e(@$info->precio); ?>">
						</div>
					</div>
					...
					<div class="form-group row" id="m_retencion"> 
						...
						<div class="col-md-9">
							<input type="text" name="retencion" id="retencion" class="form-control"  value="<?php echo e(@$info->retencion); ?>">
						</div>
					</div> -->
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
						<input type="file" name="doc_resultado" id="doc_resultado" accept=".pdf" class="form-control"  value="<?php echo e(@$info->doc_resultado); ?>" style="display:none;">
							...
							<?php 
								...
								?><a href="files/infoservicio/<?php echo e(@$info->doc_resultado); ?>" class="f_doc_resultado text-info" target="_blank" title="Descargar"><?php  echo @$info->doc_resultado; ?></a> 
								<input type="hidden" name="f_doc_resultado" id="f_doc_resultado" value="<?php echo e(@$info->doc_resultado); ?>">
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<select  id='responsable_atencion_id' name="responsable_atencion_id"  style="width: 100%;" class="select2AjaxPersona">
								<?php if(@$info->responsable_atencion_id>0): ?>
									<option selected value="<?php echo e($info->responsable_atencion_id); ?>"><?php echo e($funciones->info_persona($info->responsable_atencion_id)); ?></option>
								<?php endif; ?>
							</select>	
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<textarea class="form-control" name="observacion_resultado" id="observacion_resultado" rows="3"> <?php echo e(@$info->observacion_resultado); ?></textarea>
						</div>
					</div>
...
<?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/infoservicio/modal_form_infoservicio.blade.php ENDPATH**/ ?>