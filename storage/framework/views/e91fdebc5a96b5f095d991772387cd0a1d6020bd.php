...
<div class="modal fade" id="modal_mante" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?php echo e(route('guardar.docgeneral')); ?>" method="POST" enctype="multipart/form-data" id="frmproy">
					<?php echo csrf_field(); ?>
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							...
							<?php 
								if(@$info->archivo!=''){
								?><a href="files/docgeneral/<?php echo e(@$info->archivo); ?>" class="text-info" target="_blank" title="Descargar"><?php  echo @$info->archivo; ?></a>
							<?php }?>
...
</script><?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/docgeneral/modal_form_docgeneral.blade.php ENDPATH**/ ?>