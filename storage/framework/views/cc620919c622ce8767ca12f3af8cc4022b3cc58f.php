...
<div class="modal fade" id="modal_mante" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?php echo e(route('guardar.agre_infoinvestigacion')); ?>" method="POST" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
					 ...
					 <div class="form-group row">
						<div class="table-responsive">
							<table id="tb_table" class="table">
								...
								<tbody> 
									<?php $i = 1; ?>	
									<?php $__currentLoopData = $Actividad_investigacion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fila): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr> 
												<td> <?php $i; ?></td> 
												<td>
				...
				<div class="modal-footer">
					<input type="hidden" name="id_infoinvestigacion" value="<?php echo e(@$info->id); ?>">
...
<?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/infoinvestigacion/modal_agre_infoinvestigacion.blade.php ENDPATH**/ ?>