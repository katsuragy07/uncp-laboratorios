					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<select name="laboratorio_id" required="" class="form-control" id="cmbcargo">
								...
								<option value="<?php echo e($laboratorio->id); ?>"><?php echo e($laboratorio->nombre_lab); ?></option>
		...
		<div class="modal-dialog modal-dialog-centered text-center" role="document">
			<div class="modal-content tx-size-sm">
				<div class="modal-body text-center p-4">
					...
					<form action="<?php echo e(route('borrar.usuario')); ?>" method="POST">
						<?php echo csrf_field(); ?>
   ...
   <!-- Modal permisos-->
	<div class="modal fade" id="modal_permisos" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?php echo e(route('guardar.permisos')); ?>" method="POST">
					<?php echo csrf_field(); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                	<form action="<?php echo e(route('listar.usuarios')); ?>" method="GET">
                    <div class="row">
                        <div class="col-lg">
                        ...
                        <div class="col-lg">
                            ...
                            <input class="form-control mb-4" placeholder="" type="text" name="nombre_usuario" value="<?php echo e($databusqueda->nombre_usuario); ?>">
                        </div>
                        <div class="col-lg">
                            <label class="form-label"> Usuario</label>
                            <input class="form-control mb-4" placeholder="" type="text" name="username" value="<?php echo e($databusqueda->username); ?>">
                        </div>
                        <div class="col-lg "><br>
						...
						<table class="table table-hover card-table table-vcenter text-nowrap mb-0">
							...
							<tbody>
								...
								if(isset($_GET['page'])){
								 ...
								 ?>
								<?php $__currentLoopData = $listausers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php $i++;  ?>
									<tr>
										<td><?php echo e($i); ?></td>
										<td><?php echo e($usuario->nombre_lab); ?></td>
										<td><?php echo e($usuario->nombre_usuario); ?></td>
										<td><?php echo e($usuario->username); ?></td>
										<td><?php echo e($usuario->email); ?></td>
										<td><?php echo e(fechaHoraUsu($usuario->fecha_cambioclave)); ?></td>
										<td><?php echo e(estado($usuario->sts_usuario)); ?></td>
										<td>
											<img src="<?php echo e(asset('images/permisos.png')); ?>" width="30" style="cursor: pointer;" title="Permisos"  data-toggle="modal" data-target="#modal_permisos" onclick="permisos(<?php echo e($usuario->id); ?>)">	
										</td>
										<td>
					        				<button type="button" class="btn-info" data-toggle="modal" data-target="#modal_nuevousuario" onclick="editar(<?php echo e($usuario->id); ?>,<?php echo e($usuario->laboratorio_id); ?>,'<?php echo e($usuario->nombre_usuario); ?>','<?php echo e($usuario->email); ?>','<?php echo e($usuario->sts_usuario); ?>')" > 
					                            <i class="glyphicon glyphicon-edit"></i> 
					                        </button>

					                        <button type="button" class="btn-warning" data-toggle="modal" title="Cambiar clave" data-target="#modal_cambiarclave" onclick="cambiarclave(<?php echo e($usuario->id); ?>,'<?php echo e($usuario->username); ?>','<?php echo e($usuario->nombre_usuario); ?>','<?php echo e($usuario->email); ?>','<?php echo e($usuario->sts_usuario); ?>')" > 
					                            <i class="fa fa-refresh"></i> 
					                        </button>

					                        <button class="btn-danger" data-toggle="modal" data-target="#modal_eliminar" onclick="eliminar(<?php echo e($usuario->id); ?>,'<?php echo e($usuario->nombre_usuario); ?>')"> 
...
<script>
	...
	function permisos(idusuario){
		...
		$.ajax({
		    url:"<?php echo e(route('ver.permisos')); ?>",  
		    method:'GET',
...
<?php echo $__env->make('layouts.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/usuarios/lista_usuarios.blade.php ENDPATH**/ ?>