		...
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
					...
					<table class="table mb-0">
						<tbody>
							<tr>
								...
								<td class="py-2 px-0" id="nombre_lab"><?php echo e($funciones->Nombre_Laboratorio(Auth::user()->laboratorio_id)); ?></td>
							</tr>
							<tr>
				...
				<div class="modal-footer">
					...
					<input type="hiddenx" name="laboratorio_id" value="<?php echo e(Auth::user()->laboratorio_id); ?>"> 
 ...
 $("#equipo_id").change(function(){ 
     ...
     $.ajax({ 
            type: "post", 
                ...
                url: "<?php echo e(route('ajax.info_producto')); ?>", cache: false,
              data:{
...
recargarAjaxProdLab();
//agregarLote();
	</script><?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/equipos/modal_form_agregar_insumo_lab.blade.php ENDPATH**/ ?>