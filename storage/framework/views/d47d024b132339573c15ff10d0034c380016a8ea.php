...
<div class="modal fade" id="modal_mante" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?php echo e(route('guardar.recepcion')); ?>" method="POST" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
				<div class="modal-body"> 
					...
					<div class="form-group row">
						...
						<div class="col-md-3">
							<input type="date" name="fecha_solicitud" class="form-control"  required="" value="<?php echo e(@$info->fecha_solicitud); ?>">
						</div> 
					...
					<div class="form-group row">
						...
						<div class="col-md-3">
							<input type="date" name="fecha_recepcion" class="form-control"   value="<?php echo e((@$info->fecha_recepcion!='')?@$info->fecha_recepcion:date('Y-m-d')); ?>">
						</div> 
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<select name="proveedor_id" class="form-control"  >
								...
								<?php $__currentLoopData = $m_proveedor::orderby('proveedor','ASC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proveedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option <?php if($proveedor->id == @$info->proveedor_id): ?> selected <?php endif; ?> value="<?php echo e($proveedor->id); ?>"><?php echo e($proveedor->proveedor); ?> - <?php echo e($proveedor->ruc); ?></option>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<select name="resp_recepcion_id" class="form-control" required="" >
								<option value="">-- Seleccionar --</option>
								<?php $__currentLoopData = $m_persona::where('tipo_documento_id','!=','6')->orderby('nombres','ASC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $persona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option <?php if($persona->id == @$info->resp_recepcion_id): ?> selected <?php endif; ?> value="<?php echo e($persona->id); ?>"><?php echo e($persona->nombres); ?> <?php echo e($persona->apellidos); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input type="text" name="numdoc_sustento" class="form-control"  value="<?php echo e(@$info->numdoc_sustento); ?>">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-3 form-label">Documento Sustento (O. Compra)</label>
						<div class="col-md-6">
							<input type="file" name="doc_sustento" class="form-control"  value="<?php echo e(@$info->doc_sustento); ?>">
							<?php 
								if(@$info->doc_sustento!=''){
								?><a href="files/doc_sustento/<?php echo e(@$info->doc_sustento); ?>" class="text-info" target="_blank" title="Descargar"><?php  echo @$info->doc_sustento; ?></a>
							<?php }?>
						</div>
					</div>
...
recargarAjaxProdLab();
	...
	</script><?php /**PATH C:\wamp64\www\sistemauncp\laboratorio\resources\views/atencion/modal_form_recepcion.blade.php ENDPATH**/ ?>