...
@section('contenido')
<form class="needs-validation was-validated" action="{{ route('update.laboratorios',$laboratorios->id) }}" method="POST" enctype="multipart/form-data">
@csrf
...
<div class="row row-sm">
		<div class="col-lg-6">
			 ...
			 <label for="size_2">Código de Sunedu:&nbsp;&nbsp;&nbsp;</label>	
				...
				<textarea class="form-control mb-4 is-valid state-valid" name="nombre_lab" id="nombre_lab" placeholder="Nombre de Laboratorio" required="" rows="2">{{$laboratorios->nombre_lab}}</textarea>
				...
				<textarea class="form-control mb-4 is-valid state-valid" name="decripcion_lab" id="decripcion_lab" placeholder="Descripción"  rows="3">{{$laboratorios->decripcion_lab}}</textarea>

				<label for="size_2">Observaciones:&nbsp;&nbsp;&nbsp;</label>	
				<textarea class="form-control mb-4 is-valid state-valid" name="observaciones_lab" id="observaciones_lab" placeholder="Observaciones"  rows="3">{{$laboratorios->observaciones_lab}}</textarea>
			...
			<label for="size_2">Ubicación:&nbsp;&nbsp;&nbsp;</label>
				<textarea class="form-control mb-4 is-valid state-valid" name="ubicacion" id="ubicacion" placeholder="Referencia de ubicación del laboratorio o taller (Local):"  rows="2">{{$laboratorios->ubicacion}}</textarea>

				<label for="size_2">Que servicios brinda para la enseñanza?:&nbsp;&nbsp;&nbsp;</label>
				<textarea class="form-control mb-4 is-valid state-valid" name="tipos_de_ensenanza" id="tipos_de_ensenanza" placeholder="Que servicios brinda para la enseñanza?"  rows="5">{{$laboratorios->tipos_de_ensenanza}}</textarea>
		...
		<div class="col-lg-6">								
			...
			<input type="file" name="foto_laboratorio" id="foto_laboratorio" accept=".pdf" class="form-control"  value="{{ @$laboratorios->foto_laboratorio }} " style="display:none;">
			<div class="flex mt-2" style="padding: 5px;align-items: center;text-align: center;border-radius: 5px;border: dashed 1px #29327f;cursor: pointer;color: #29327f;" id="op_foto_laboratorio">
				...
				<div class="flex m-2" style="color: #29327f;font-size: 1.1rem;max-width: 100%;" id="val_foto_laboratorio"></div>
							...
							<?php 
								...
								?><a href="../files/laboratorio/{{$laboratorios->foto_laboratorio}}" class="f_foto_laboratorio text-info" target="_blank" title="Descargar"><?php  echo @$laboratorios->foto_laboratorio; ?></a>
								<input type="hidden" name="f_foto_laboratorio" id="f_foto_laboratorio" value="{{@$info->foto_laboratorio}}">
			...
			<input type="file" name="organigrama" id="organigrama" accept=".pdf" class="form-control" value="{{ @$laboratorios->organigrama }} " style="display:none;" >
			<div class="flex mt-2" style="padding: 5px;align-items: center;text-align: center;border-radius: 5px;border: dashed 1px #29327f;cursor: pointer;color: #29327f;" id="op_organigrama">
				...
				<div class="flex m-2" style="color: #29327f;font-size: 1.1rem;max-width: 100%;" id="val_organigrama"></div>
							...
							<?php 
								...
								?><a href="../files/laboratorio/{{$laboratorios->organigrama}}" class="f_organigrama text-info" target="_blank" title="Descargar"><?php  echo @$laboratorios->organigrama; ?></a>
								<input type="hidden" name="f_organigrama" id="f_organigrama" value="{{@$info->organigrama}}">
			...
			<br><br><br><label for="size_2">Resolución de Creación del Laboratorio (.pdf)&nbsp;&nbsp;&nbsp;</label>
				<input type="file" name="resolucion_creacion" id="resolucion_creacion" accept=".pdf" class="form-control" value="{{ @$laboratorios->resolucion_creacion }} " style="display:none;" >
				...
				<div class="flex m-2" style="color: #29327f;font-size: 1.1rem;max-width: 100%;" id="val_resolucion_creacion"></div>
							...
							<?php 
								...
								?><a href="../files/laboratorio/{{$laboratorios->resolucion_creacion}}" class="f_resolucion_creacion text-info" target="_blank" title="Descargar"><?php  echo @$laboratorios->resolucion_creacion; ?></a>
								<input type="hidden" name="f_resolucion_creacion" id="f_resolucion_creacion" value="{{@$info->resolucion_creacion}}">
...
<div class="d-none">
			...
			<label for="size_2">Horario de Atención del Laboratorio (.pdf) &nbsp;&nbsp;&nbsp;</label>
				<input type="file" name="horario_atencion" id="horario_atencion" accept=".pdf" class="form-control" value="{{ @$laboratorios->horario_atencion }} " style="display:none;" >
				...
				<div class="flex m-2" style="color: #29327f;font-size: 1.1rem;max-width: 100%;" id="val_horario_atencion"></div>
							...
							<?php 
								...
								?><a href="../files/laboratorio/{{$laboratorios->horario_atencion}}" class="f_horario_atencion text-info" target="_blank" title="Descargar"><?php  echo @$laboratorios->horario_atencion; ?></a>
								<input type="hidden" name="f_horario_atencion" id="f_horario_atencion" value="{{@$info->horario_atencion}}">
