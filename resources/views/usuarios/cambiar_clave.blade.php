...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" version="XHTML+RDFa 1.0" dir="ltr"
  ...
  xmlns:xsd="http://www.w3.org/2001/XMLSchema#">
	...
	<body class="h-100vh page-style1">
				...
				<div class="container">
							...
							<div class="row justify-content-center">
								<div class="col-md-7 col-lg-4">
									<div class="error-logo">
										<a href="#"><img src="{{ asset('images/logodtt.png') }}" class="header-brand-img" alt="logo"></a>
									</div>
									<div class="card">
									<div class="card-body">
					...
					@csrf
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" disabled="" value="{{ $funciones->Nombre_Facultad(Auth::user()->laboratorio_id) }}">


											</div>
											<div class="form-group">
												<label class="form-label text-muted font-weight-normal">Laboratorio</label>
												<input type="text" class="form-control" disabled name="username" value="{{ $funciones->Nombre_Laboratorio(Auth::user()->laboratorio_id) }}">
											</div>
											<div class="form-group">
												<label class="form-label text-muted font-weight-normal"><b>Nombres y Apellidos</b></label>
												<input type="text" required="" minlength="6" class="form-control" name="nombre_usuario" value="{{ $info->nombre_usuario }}">
											</div>

											<div class="form-group">
												<label class="form-label text-muted font-weight-normal">Usuario</label>
												<input type="text" class="form-control" disabled="" name="username" value="{{ $info->username }}">
											</div>
											...
											<div class="row">
												<div class="col-12 mt-5">
													...
													<a  href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-formx').submit();" class="btn btn-lg btn-default btn-block">Salir</a>
												</div>
		...
		<form id="logout-formx" action="{{ route('logout') }}" method="POST" class="d-none">
			                                        @csrf
			                                    </form>
