...
@section('titulo','Facultad / Dependencia')
@section('contenido')
<div class=""> <!-- container -->
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg">
                            ...
                            <input class="form-control mb-4" placeholder="Nombe Facultad / Dependencia" type="text" name="nombre_facultad" value="{{ $databusqueda->nombre_facultad}}">
                        </div>
								...
								<?php $i++;  ?>
									...
									<?php
											...
											?>
														...
														<a href="{{ $ruta_calen }}" target="_blank" title="Descargar">
									...
									<td>
					        				...
					        				<button type="button" class="btn-info" data-toggle="modal" data-target="#modal_nuevafacultad" onclick="editar('{{ $facultad->id }}','{{ $facultad->nom_facultad }}','{{ $facultad->status }}','{{ $facultad->organigrama }}')" > 
					                            <i class="glyphicon glyphicon-edit"></i> 
					                        </button>

			

					                        <button class="btn-danger" data-toggle="modal" data-target="#modal_eliminarfacultad" onclick="eliminar('{{ $facultad->id}}','{{ $facultad->nom_facultad }}','{{ $facultad->organigrama }}')"> 
