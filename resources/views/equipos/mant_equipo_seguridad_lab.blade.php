   ...
   <!-- Modal Nuevo y editar -->
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                	<form class="form-horizontal" action="{{ route('mant.equipo_seguridad_lab') }}" method="POST" enctype="multipart/form-data">
                		@csrf
							...
							<tbody>
								...
								$i++;  ?>
									<tr>
										...
										@if($databusqueda->laboratorio_id>0)
											<td><input type="number" name="cantidad<?php echo $fila->id; ?>" class="zform-control" value="{{ $fila->cantidad }}"></td>
											<td><input type="text" name="estado<?php echo $fila->id; ?>" class="zform-control" value="{{ $fila->estado }}"></td>
											<td><input type="text" name="motivo_elim<?php echo $fila->id; ?>" class="zform-control" value="{{ $fila->motivo_elim }}"></td>
										@endif
