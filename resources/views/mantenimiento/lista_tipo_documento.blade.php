...
@section('titulo','Tipo Documento de Identidad')
@section('contenido')
<div class=""> <!-- container -->
   ...
   <!-- Modal Nuevo y editar -->
	<div class="modal fade" id="modal_nuevo" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="{{ route('guardar.tipo_documento') }}" method="POST">
					@csrf					
		...
		<div class="modal-dialog modal-dialog-centered text-center" role="document">
			<div class="modal-content tx-size-sm">
				<div class="modal-body text-center p-4">
					...
					<form action="{{ route('borrar.tipo_documento') }}" method="POST">
						@csrf
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                	<form action="{{ route('listar.tipo_documento') }}" method="GET">
                    <div class="row">
                        <div class="col-lg">
                            <label class="form-label"> Tipo Documento de Identidad</label>
                            <input class="form-control mb-4" placeholder="" type="text" name="tipo_documento" value="{{ $databusqueda->tipo_documento }}">
                        </div>
                        <div class="col-lg "><br>
