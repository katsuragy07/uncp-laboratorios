   ...
   <!-- Modal Nuevo y editar -->
	<div class="modal fade" id="modal_nuevo" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="{{ route('guardar.cargo') }}" method="POST">
					@csrf					
		...
		<div class="modal-dialog modal-dialog-centered text-center" role="document">
			<div class="modal-content tx-size-sm">
				<div class="modal-body text-center p-4">
					...
					<form action="{{ route('borrar.cargo') }}" method="POST">
						@csrf
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                	<form action="{{ route('listar.cargo') }}" method="GET">
                    <div class="row">
                        <div class="col-lg">
                            <label class="form-label"> Cargo</label>
                            <input class="form-control mb-4" placeholder="" type="text" name="cargo" value="{{ $databusqueda->cargo }}">
                        </div>
                        <div class="col-lg "><br>
							...
							<tbody>
								...
								<?php $i++;  ?>
									<tr>
										...
										<td>
											@if($fila->id>3)
					        				<button type="button" class="btn-info" data-toggle="modal" data-target="#modal_nuevo" onclick="editar({{ $fila->id }},'{{ $fila->cargo }}')" > 
					                            <i class="glyphicon glyphicon-edit"></i> 
					                        </button>

					                        <button class="btn-danger" data-toggle="modal" data-target="#modal_eliminar" onclick="eliminar({{ $fila->id}},'{{ $fila->cargo }}')"> 
