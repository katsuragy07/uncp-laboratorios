...
@section('titulo','Catálogo - Equipos de seguridad')
@section('contenido')
<div class=""> <!-- container -->
   ...
   <!-- Modal Nuevo y editar -->
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                	<form action="{{ route('listar.equipo_seguridad') }}" method="GET">
                    <div class="row">
                        <div class="col-lg">
                            <label class="form-label"> Equipo de seguridad</label>
                            <input class="form-control mb-4" placeholder="" type="text" name="equipo_seguridad" value="{{ $databusqueda->equipo_seguridad }}">
                        </div>
                        <div class="col-lg "><br>
							...
							<tbody>
								...
								<?php $i++;  ?>
									<tr>
										...
										<td>
					        				<button type="button" class="btn-info" data-toggle="modal" data-target="#modal_nuevo" onclick="editar({{ $fila->id }},'{{ $fila->equipo_seguridad }}','{{ $fila->tipo }}')" > 
					                            <i class="glyphicon glyphicon-edit"></i> 
					                        </button>

					                        <button class="btn-danger" data-toggle="modal" data-target="#modal_eliminar" onclick="eliminar({{ $fila->id}},'{{ $fila->equipo_seguridad }}')"> 
