...
@section('titulo','Semestre Académico')
@section('contenido')
<div class=""> <!-- container -->
   ...
   <!-- Modal Nuevo y editar -->
	<div class="modal fade" id="modal_nuevo" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="{{ route('guardar.periodo') }}" method="POST">
					@csrf					
		...
		<div class="modal-dialog modal-dialog-centered text-center" role="document">
			<div class="modal-content tx-size-sm">
				<div class="modal-body text-center p-4">
					...
					<form action="{{ route('borrar.periodo') }}" method="POST">
						@csrf
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                	<form action="{{ route('listar.periodo') }}" method="GET">
                    <div class="row">
                        <div class="col-lg">
                            <label class="form-label"> Periodo Académico</label>
                            <input class="form-control mb-4" placeholder="" type="text" name="periodo" value="{{ $databusqueda->periodo }}">
                        </div>
                        <div class="col-lg "><br>
							...
							<tbody>
								...
								<?php $i++;  ?>
									<tr>
										...
										<td>
					        				<button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal_nuevo" onclick="editar({{ $fila->id }},'{{ $fila->periodo }}')" > 
					                            <i class="glyphicon glyphicon-edit"></i> 
					                        </button>

					                        <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal_eliminar" onclick="eliminar({{ $fila->id}},'{{ $fila->periodo }}')"> 
