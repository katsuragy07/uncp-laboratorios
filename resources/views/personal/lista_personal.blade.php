...
@section('titulo','Personales Responsables')
@section('contenido')
<div class=""> <!-- container -->
...
<div id="div_ModalMant">		
		...
		<div class="modal-dialog modal-dialog-centered text-center" role="document">
			<div class="modal-content tx-size-sm">
				<div class="modal-body text-center p-4">
					...
					<form action="{{ route('editar.personal') }}" method="POST">
						@csrf
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                	<form action="{{ route('listado.personal') }}" method="GET">
                    <div class="row">
                        <div class="col-md-6">
									...
									<tr>
										...
										<td> 
											...
											?>
														...
														<a href="{{ $ruta_hoja_vida }}" target="_blank" title="Descargar">
										...
										<?php
											...
											?>
														...
														<a href="{{ $ruta_resolucion }}" target="_blank">
										...
										<button type="button" class="btn-info editardato" value="{{ $fila->id }}" > 
					                        ...
					                        <button class="btn-danger" data-toggle="modal" data-target="#modal_eliminar" onclick="eliminar({{ $fila->id}},'{{ $fila->apellidos .' '.$fila->nombres  }}')"> 
...
<script>
 $("#btnnuevo").click(function(event){ 
    ...
    var urlnuevo = "{{ route('mant_personal') }}";
	...
	$(".editardato").click(function(event){
	    ...
	    var url = "{{ route('mant_personal') }}?id="+idtablas;
	    $( "#div_ModalMant" ).html('Cargando...');
