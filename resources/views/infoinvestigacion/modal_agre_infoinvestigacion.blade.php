...
<div class="modal fade" id="modal_mante" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="{{ route('guardar.agre_infoinvestigacion') }}" method="POST" enctype="multipart/form-data">
					@csrf
					 ...
					 <div class="form-group row">
						<div class="table-responsive">
							<table id="tb_table" class="table">
								...
								<tbody> 
									<?php $i = 1; ?>	
									@foreach($Actividad_investigacion  as $fila)
											<tr> 
												<td> <?php $i; ?></td> 
												<td>
				...
				<div class="modal-footer">
					<input type="hidden" name="id_infoinvestigacion" value="{{ @$info->id }}">
