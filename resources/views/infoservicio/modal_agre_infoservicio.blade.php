...
<div class="modal fade" id="modal_mante" tabindex="-1" role="dialog" aria-labelledby="largemodal" aria-hidden="true">
		<div class="modal-dialog modal-lg " role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="{{ route('guardar.agre_infoservicio') }}" method="POST" enctype="multipart/form-data">
					@csrf
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<input type="text" name="producto" id="producto" class="form-control"  autocomplete="off" value="{{ @$info->producto }}">
						</div>
					</div>
					 <!--INICIO DETALLE-->				
					 <div class="form-group row">
						<div class="table-responsive">
							<table id="tb_table" class="table">
								...
								<tbody> 
									<?php $i = 1; ?>	
									@foreach($actividad_infoservicio  as $fila)
											<tr> 
												<td> <?php $i; ?></td> 
												<td>
				...
				<div class="modal-footer">
					<input type="hidden" name="info_servicio_id" value="{{ @$info->id }}">
