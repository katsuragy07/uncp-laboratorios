...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" version="XHTML+RDFa 1.0" dir="ltr"
  ...
  xmlns:xsd="http://www.w3.org/2001/XMLSchema#">
	<head profile="http://www.w3.org/1999/xhtml/vocab">
		...
		<!--Favicon -->
		<link rel="icon" href="{{ asset('images/logouncp.png') }}" type="image/x-icon"/>
		...
		<link href="{{ asset('zendash/assets/plugins/notify/css/notifIt.css') }}" rel="stylesheet" />

		<!-- INTERNAl Tabs css-->
		<link href="{{ asset('zendash/assets/plugins/tabs/tabs.css') }}" rel="stylesheet" />
...
/* background-color: yellow !important; */
	...
	<body class="app sidebar-mini">
				...
				<aside class="app-sidebar">
					<div class="app-sidebar__logo">
						<a class="header-brand" href="{{ route('home') }}">
							<img src="{{ asset('images/logodtt.png') }}" class="header-brand-img desktop-lgo" alt="Covido logo">
							<img src="{{ asset('images/logodtt.png') }}" class="header-brand-img dark-logo" alt="Covido logo">
							<img src="{{ asset('images/logodtt.png') }}" class="header-brand-img mobile-logo" alt="Covido logo">
							<img src="{{ asset('images/logodtt.png') }}" class="header-brand-img darkmobile-logo" alt="Covido logo">
						</a>
					</div>
					<div class="app-sidebar3">
						...
						<!--	<li><h3>Administracion</h3></li>-->
							...
							<svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
								...
								<ul class="slide-menu">
									@if($userId==1)
										<li><a href="{{ route('listado.docgeneral') }}" class="slide-item">Documentos Generales</a></li>
										<li><a href="{{ route('listar.facultades') }}" class="slide-item">Facultad/Dependencia</a></li>
										<li><a href="{{ route('listar.laboratorios') }}" class="slide-item">Lista de Laboratorios</a></li>
										
									@else
										<li><a href="{{route('editar.laboratorios',Auth::user()->laboratorio_id) }}" class="slide-item">Editar información General</a></li>
									@endif
									@if(Auth::user()->laboratorio_id!=1 or $userId==1)
										<li><a href="{{ route('lista.tipo_laboratorio') }}" class="slide-item">Tipo de Laboratorios</a></li>
									@endif
										<li><a href="{{ route('listado.docespecifico') }}" class="slide-item">Documentos Especificos</a></li>
										<li><a href="{{ route('listado.personal') }}" class="slide-item">Personal Responsable</a></li>

									@if($funciones->existe_tipo_laboratorio(Auth::user()->laboratorio_id,1)>0 or $funciones->existe_tipo_laboratorio(Auth::user()->laboratorio_id,4)>0 or $userId==1)
										<li><a href="{{ route('listado.infoacademica') }}" class="slide-item">Laboratorio de Enseñanza</a></li>
									@endif
									@if($funciones->existe_tipo_laboratorio(Auth::user()->laboratorio_id,2)>0 or $userId==1)
										<li><a href="{{ route('listado.infoservicio') }}" class="slide-item">Laboratorio de Servicio</a></li>
									@endif
									@if($funciones->existe_tipo_laboratorio(Auth::user()->laboratorio_id,3)>0 or $userId==1)
										<li><a href="{{ route('listado.investigacion') }}" class="slide-item">Laboratorio de Investigación</a></li>
									@endif
							...
							<svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
								...
								<ul class="slide-menu">
									@if($categoria_lab!=3 or $userId==1)
										<li><a href="{{ route('listar.atencion') }}" class="slide-item">Atenciones</a></li>
									@endif

									<li><a href="{{ route('listar.recepcion') }}" class="slide-item">Recepción</a></li>

									 
										<li><a href="{{ route('listar.requerimiento') }}" class="slide-item">Requerimiento Lab.</a></li>
								

									<li><a href="{{ route('listar.movimiento') }}" class="slide-item">Movimiento - Kardex</a></li>
							...
							<svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
								...
								<ul class="slide-menu">
									<li><a href="{{ route('listar.equipos') }}" class="slide-item">Lista de Equipos</a></li>
									<li><a href="{{ route('listar.material') }}" class="slide-item">Lista de Materiales</a></li>
									<li><a href="{{ route('listar.insumos') }}" class="slide-item">Lista de Insumos</a></li>
									<li><a href="{{ route('listar.equipo_seguridad_lab') }}" class="slide-item">Lista de Equipos de Seguridad</a></li>
									<li><a href="{{ route('listado_software') }}" class="slide-item">Lista de Software Original de Lab.</a></li>
									<li><a href="{{ route('listar.componentes') }}" class="slide-item">Lista de Componentes de Lab.</a></li>
								</ul>
							</li>
							<li class="slide">
								<a class="side-menu__item" data-toggle="slide" href="#">
							...
							<svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
								...
								<ul class="slide-menu">
									...
									<li><a href="{{ route('listar.persona') }}" class="slide-item">Personas</a></li>
									<li><a href="{{ route('listar.proveedor') }}" class="slide-item">Proveedores</a></li>
									<li><a href="{{ route('listar.cargo') }}" class="slide-item">Cargos</a></li>
									<li><a href="{{ route('listar.equipo_seguridad') }}" class="slide-item">Catálogo de equipos de seguridad</a></li>
									<li><a href="{{ route('listar.tipo_doc_equipo') }}" class="slide-item">Catálogo de doc. equipos</a></li>
									<li><a href="{{ route('listar.tipo_doc_especifico') }}" class="slide-item">Catálogo de doc. lab.</a></li>
									<li><a href="{{ route('listar.tipo_documento') }}" class="slide-item">Tipo doc. identidad</a></li>
									<li><a href="{{ route('listar.tipo_equipo') }}" class="slide-item">Tipo de equipo</a></li>
									<!--<li><a href="{{ route('listar.tipo_laboratorio') }}" class="slide-item">Tipo de laboratorio</a></li>-->
									<li><a href="{{ route('listar.tipo_personal') }}" class="slide-item">Tipo de personal</a></li>
									<li><a href="{{ route('listar.tipo_fiscalizado') }}" class="slide-item">Tipo de fiscalización</a></li>
									<li><a href="{{ route('listar.ubigeo') }}" class="slide-item">Ubigeo</a></li>
									<li><a href="{{ route('listar.tipo_movimiento') }}" class="slide-item">Tipo movimiento</a></li>
									<li><a href="{{ route('listar.unidad_medida') }}" class="slide-item">Unidad de medida</a></li>
									<li><a href="{{ route('listar.periodo') }}" class="slide-item">Semestre académico</a></li>
									<li><a href="{{ route('listar.asignatura') }}" class="slide-item">Asignaturas</a></li>
								</ul>
							</li>
							...
							<svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
								...
								<ul class="slide-menu">
									...
									<li><a href="{{ route('pdf.adeudo_material') }}" target="_blank" class="slide-item">Lista de adeudo</a></li>
							...
							@if($userId==1)
								...
								<svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
									...
									<ul class="slide-menu">
										<li><a href="{{ route('listar.usuarios') }}" class="slide-item">Lista de usuarios</a></li>
									</ul>
								</li>
							@endif
							...
							<div class="container-fluid">
								<div class="d-flex">
									<a class="header-brand" href="index.html">
										<img src="{{ asset('images/logodtt.png') }}" class="header-brand-img desktop-lgo" alt="Zendashlogo">
										<img src="{{ asset('images/logodtt.png') }}" class="header-brand-img dark-logo" alt="Zendashlogo">
										<img src="{{ asset('images/logodtt.png') }}" class="header-brand-img mobile-logo" alt="Zendashlogo">
										<img src="{{ asset('images/logodtt.png') }}" class="header-brand-img darkmobile-logo" alt="Zendashlogo">
									</a>
									...
									<div class="d-flex order-lg-2 ml-auto">
										...
										<div class="dropdown profile-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated p-0">
												...
												<a class="dropdown-item border-bottom" href="{{ route('cambiar.clave') }}">
													<i class="dropdown-icon  mdi mdi-settings"></i> Cambiar clave
												</a> 
												
												<a class="dropdown-item border-bottom" target="_blank" href="{{ url('files/docgeneral/Manual de Usuario - Laboratorio.pdf') }}">
		...
		<script src="{{ asset('zendash/assets/plugins/notify/js/notifIt.js') }}"></script>
		
		<!--- INTERNAl Tabs js-->
		<script src="{{ asset('zendash/assets/plugins/tabs/jquery.multipurpose_tabcontent.js') }}"></script>
		<script src="{{ asset('zendash/assets/js/tabs.js') }}"></script>
 ...
 //Consultas Ajax para select2
  function recargarAjaxProdLab(){
	$('.select2AjaxProductoLab').select2({
		...
		ajax: {
		  url: '{{ route('ajax.producto_laboratorio_select2') }}',
  ...
  function recargarAjaxPersona(){
	  $('.select2AjaxPersona').select2({
			...
			minimumInputLength: 3,
			ajax: {
			  url: '{{ route('ajax.persona_select2') }}',
			  dataType: 'json', 
			  delay: 300,
			  processResults: function (data) {
				return {
