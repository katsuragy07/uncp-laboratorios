                                        ...
                                        <div class="card-body page-single-content">
                                            <div class="w-100">
                                                <div class="custom-logo">
                                                    ...
                                                    <img src="{{ asset('images/logouncp.png') }}" class="header-brand-img dark-logo" alt="logo">
                                                ...
                                                <div class="input-group mb-4">
                                                    <input id="email" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="off" autofocus placeholder="Usuario: CÓD. SUNEDU">
                                                ...
                                                <div class="input-group mb-4">
                                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Contraseña: 123">
                                    ...
                                    <div class="card text-white custom-content page-content mt-0">
                                        <div class="card-body text-center justify-content-center">
                                            ...
                                            <div class="custom-logo1">
                                                <a href="index.html"><img src="{{ asset('images/logodtt.png') }}" class="header-brand-img dark-logo" alt="logo"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
